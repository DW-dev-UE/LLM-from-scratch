...
いまベンチに載せた実学習チェックポイントは **base 約 327M** です。→ [BENCHMARK v1](BENCHMARK-v1.ja.md)
...
**sft_base_v1 · 通常チャットモード（THINKING オフ）**
...
| THINKING オン | 回答 0 / 14（終了タグ未閉じ問題） |

学習過程、データセット、設問ごとの質問·回答はここ:
