[![한국어](https://img.shields.io/badge/%ED%95%9C%EA%B5%AD%EC%96%B4-8B949E?style=flat-square)](BENCHMARK-v1.md) [![English](https://img.shields.io/badge/English-8B949E?style=flat-square)](BENCHMARK-v1.en.md) [![日本語](https://img.shields.io/badge/%E6%97%A5%E6%9C%AC%E8%AA%9E-0969DA?style=flat-square)](BENCHMARK-v1.ja.md)
...
> [!NOTE]
> ko-wiki val loss は v1 よりわずかに悪化 (報告: 2.504 → 2.605) したが、  
...
> [!WARNING]
> 最初の v6 ベンチ実行では `max_think` と `max_new` が予算を共有し、回答が空になるバグがありました。  
